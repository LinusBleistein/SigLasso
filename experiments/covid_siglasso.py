...
print(Y_train.ndim,Y_train.shape) #n_samples, time, channels
...
for horizon in list(horizons):
    ...
    for sig_o in model_hyperparams['lasso']['sig_order']:
        print(horizon)
        print(f'Train lasso for signature order {sig_o}')

        #        lasso_sig_n = SigLasso(
        #            sig_o, model_hyperparams['lasso']['alpha_grid'],
        #            max_iter=1e09, normalize=True, weighted=False)
...
results_SigSparse_n.to_csv(result_path + "results_SigSparse_norm_normalized.cvs")
results_test_SigSparse_n.to_csv(result_path + "results_test_SigSparse_norm_normalized.cvs")
...
results_SigSparse_nw.to_csv(result_path + "results_covid/results_SigSparse_norm_normalized_weighted.cvs")
results_test_SigSparse_nw.to_csv(result_path + "results_covid/results_test_SigSparse_norm_normalized_weighted.cvs")